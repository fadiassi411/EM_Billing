# Watchdog Energy Management

Watchdog Energy Management — Watch Every Watt. Local web-based energy metering and shop billing system by MicroBrain, built with ASP.NET Core 8, Entity Framework Core, and SQLite.

## Customer installation

1. Download the Watchdog Energy Management v4.2.0 Windows package from the latest GitHub release.
...
The complete customer manual is bundled with every installation. Open **Main > Help** in Watchdog to view or download it without an internet connection.
...
- In Windows Services, **Watchdog Energy Management Server** should show `Running` and `Automatic (Delayed Start)`. The installer configures three automatic restart attempts after failures.
...
Watchdog Energy Management — Watch Every Watt. By MicroBrain / Fadi Assi.
